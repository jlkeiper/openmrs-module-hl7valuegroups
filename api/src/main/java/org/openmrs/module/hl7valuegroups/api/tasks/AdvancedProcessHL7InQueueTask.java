 ...
 */
package org.openmrs.module.hl7valuegroups.api.tasks;
...
import org.openmrs.module.hl7valuegroups.api.hl7.AdvancedHL7InQueueProcessor;
 ...
 */
public class AdvancedProcessHL7InQueueTask extends AbstractTask {

	// Logger
	private static Log log = LogFactory.getLog(AdvancedProcessHL7InQueueTask.class);

	// Instance of hl7 processor
	private static AdvancedHL7InQueueProcessor processor = null;

	/**
	 * Default Constructor (Uses SchedulerConstants.username and SchedulerConstants.password
	 */
	public AdvancedProcessHL7InQueueTask() {
		if (processor == null) {
			processor = new AdvancedHL7InQueueProcessor();
		}
	}
