...
/**
 * Performs the work of a normal ORU^R01 Handler with the added benefit of saving value grouped observations
 *
 * @see HL7InQueueProcessor
 */
public class ValueGroupORUR01Handler implements Application {

	private Log log = LogFactory.getLog(ValueGroupORUR01Handler.class);
	 ...
	 * @should set value_Coded matching a boolean concept for obs if the answer is 0 or 1 and Question datatype is coded
	 * @should set value as boolean for obs if the answer is 0 or 1 and Question datatype is Boolean
	 * @should set value_Numeric for obs if Question datatype is Numeric and the answer is either 0 or 1
