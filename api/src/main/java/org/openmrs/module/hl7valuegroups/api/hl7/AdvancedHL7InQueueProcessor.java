 ...
 */
package org.openmrs.module.hl7valuegroups.api.hl7;
 ...
 */
@Transactional
public class AdvancedHL7InQueueProcessor /* implements Runnable */{
	...
	private HL7ValueGroupsService hl7ValueGroupsService;
	 ...
	 */
	public AdvancedHL7InQueueProcessor() {
	}
	...
	public void processHL7InQueue(HL7InQueue hl7InQueue) {
		...
		try {
			hl7ValueGroupsService.processHL7InQueue(hl7InQueue);
		}
